    ...
    ;%***********************
        ...
        ;%
            ...
            section.data(7)  = dumData; %prealloc
                    ...
                    ;% dexojrsdjj.Thresholdforeachpixel7_const
                    section.data(3).logicalSrcIdx = 3;
                    section.data(3).dtTransOffset = 2;

                    ;% dexojrsdjj.Thresholdforeachpixel6_const
                    section.data(4).logicalSrcIdx = 4;
                    section.data(4).dtTransOffset = 3;

                    ;% dexojrsdjj.Thresholdforeachpixel5_const
                    ...
                    ;% dexojrsdjj.Thresholdforeachpixel4_const
    ...
    ;%**************************
        ...
        ;%
            ...
            section.data(13)  = dumData; %prealloc
                    ...
                    ;% ntrh2fpvwnc.kryty5hpmj
                    section.data(5).logicalSrcIdx = 7;
                    section.data(5).dtTransOffset = 4;

                    ;% ntrh2fpvwnc.lizo1ppdvy
                    section.data(6).logicalSrcIdx = 8;
                    section.data(6).dtTransOffset = 5;

                    ;% ntrh2fpvwnc.g031wczkfp
                    section.data(7).logicalSrcIdx = 9;
                    section.data(7).dtTransOffset = 4805;

                    ;% ntrh2fpvwnc.jsbgvgc5ws
                    section.data(8).logicalSrcIdx = 10;
                    section.data(8).dtTransOffset = 10461;

                    ;% ntrh2fpvwnc.gtmmxvbeqy
                    section.data(9).logicalSrcIdx = 11;
                    section.data(9).dtTransOffset = 13821;

                    ;% ntrh2fpvwnc.dkak5icyiv
                    section.data(10).logicalSrcIdx = 12;
                    section.data(10).dtTransOffset = 15221;

                    ;% ntrh2fpvwnc.dloyydo5jj
                    section.data(11).logicalSrcIdx = 13;
                    section.data(11).dtTransOffset = 21221;

                    ;% ntrh2fpvwnc.nvkqlszayz
                    section.data(12).logicalSrcIdx = 14;
                    section.data(12).dtTransOffset = 22341;

                    ;% ntrh2fpvwnc.fkvds0w53e
                    section.data(13).logicalSrcIdx = 15;
                    section.data(13).dtTransOffset = 22671;
            ...
            section.data(3)  = dumData; %prealloc
                    ...
                    ;% ntrh2fpvwnc.fxgka2mnesn.j2ec3adbf2
    ...
    ;%*******************
        ...
        ;%
            ...
            section.data(1)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.aj4bgyu4ed
            ...
            section.data(1)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.hcuxpga5wk
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.kftxgmh4zz
            ...
            section.data(1)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.ptydr21zm4
    ...
    targMap.checksum0 = 2596198423;
    targMap.checksum1 = 1987169768;
    targMap.checksum2 = 1526152385;
    targMap.checksum3 = 1478317279;
